...
const FmgrBuiltin fmgr_builtins[] = {
  ...
  { 2599, 0, true, true, "pg_timezone_abbrevs_abbrevs", pg_timezone_abbrevs_abbrevs },
  ...
  { 8047, 1, true, false, "gist_stratnum_common", gist_stratnum_common },
  { 8048, 3, true, false, "has_largeobject_privilege_name_id", has_largeobject_privilege_name_id },
  { 8049, 2, true, false, "has_largeobject_privilege_id", has_largeobject_privilege_id },
  { 8050, 3, true, false, "has_largeobject_privilege_id_id", has_largeobject_privilege_id_id },
  { 8402, 1, true, false, "generate_series_timestamp_support", generate_series_timestamp_support },
  { 8403, 1, true, false, "pg_stat_get_db_parallel_workers_to_launch", pg_stat_get_db_parallel_workers_to_launch },
  { 8404, 1, true, false, "pg_stat_get_db_parallel_workers_launched", pg_stat_get_db_parallel_workers_launched },
  { 8405, 1, true, false, "generate_series_numeric_support", generate_series_numeric_support },
  { 8406, 1, true, false, "pg_stat_get_total_vacuum_time", pg_stat_get_total_vacuum_time },
  { 8407, 1, true, false, "pg_stat_get_total_autovacuum_time", pg_stat_get_total_autovacuum_time },
  { 8408, 1, true, false, "pg_stat_get_total_analyze_time", pg_stat_get_total_analyze_time },
  { 8409, 1, true, false, "pg_stat_get_total_autoanalyze_time", pg_stat_get_total_autoanalyze_time },
  { 8459, 1, false, false, "pg_restore_relation_stats", pg_restore_relation_stats },
  { 8461, 1, false, false, "pg_restore_attribute_stats", pg_restore_attribute_stats },
  { 8571, 1, true, false, "crc32_bytea", crc32_bytea },
  { 8572, 1, true, false, "crc32c_bytea", crc32c_bytea },
  { 8573, 0, true, false, "pg_stat_get_checkpointer_slru_written", pg_stat_get_checkpointer_slru_written },
  { 8597, 2, true, false, "record_larger", record_larger },
  { 8598, 2, true, false, "record_smaller", record_smaller },
  { 8599, 0, true, false, "pg_stat_get_checkpointer_num_performed", pg_stat_get_checkpointer_num_performed },
  { 8680, 1, true, false, "array_append_support", array_append_support },
  { 8681, 1, true, false, "array_prepend_support", array_prepend_support },
  { 8682, 1, true, false, "array_subscript_handler_support", array_subscript_handler_support },
  { 8686, 1, true, false, "array_reverse", array_reverse },
  { 8730, 3, true, false, "pg_get_acl", pg_get_acl },
  { 8806, 1, true, true, "pg_stat_get_backend_io", pg_stat_get_backend_io },
  { 8807, 1, true, false, "pg_stat_reset_backend_stats", pg_stat_reset_backend_stats },
  { 8920, 2, true, false, "bytea_larger", bytea_larger },
  { 8921, 2, true, false, "bytea_smaller", bytea_smaller },
  { 9160, 1, false, false, "pg_clear_relation_stats", pg_clear_relation_stats },
  { 9162, 3, false, false, "pg_clear_attribute_stats", pg_clear_attribute_stats },
  { 9220, 0, true, true, "pg_ls_summariesdir", pg_ls_summariesdir },
  { 9221, 0, true, true, "pg_timezone_abbrevs_zone", pg_timezone_abbrevs_zone },
  { 9569, 1, true, false, "casefold", casefold },
  { 9708, 1, true, false, "hashbytea", hashbytea },
  { 9709, 2, true, false, "hashbyteaextended", hashbyteaextended },
  { 9710, 1, true, false, "hashdate", hashdate },
  { 9711, 2, true, false, "hashdateextended", hashdateextended },
  { 9712, 1, true, false, "hashbool", hashbool },
  { 9713, 2, true, false, "hashboolextended", hashboolextended },
  { 9714, 1, true, false, "hashxid", hashxid },
  { 9715, 2, true, false, "hashxidextended", hashxidextended },
  { 9716, 1, true, false, "hashxid8", hashxid8 },
  { 9717, 2, true, false, "hashxid8extended", hashxid8extended },
  { 9718, 1, true, false, "hashcid", hashcid },
  { 9719, 2, true, false, "hashcidextended", hashcidextended },
  { 9720, 1, true, false, "timestamptz_hash", timestamptz_hash },
  { 9721, 2, true, false, "timestamptz_hash_extended", timestamptz_hash_extended },
  { 9876, 1, true, false, "pg_get_sequence_data", pg_get_sequence_data },
  { 9895, 0, true, false, "gen_random_uuid", gen_random_uuid },
  { 9896, 0, true, false, "uuidv7", uuidv7 },
  { 9897, 1, true, false, "uuidv7_interval", uuidv7_interval }
};

const int fmgr_nbuiltins = (sizeof(fmgr_builtins) / sizeof(FmgrBuiltin));

const Oid fmgr_last_builtin_oid = 9897;

const uint16 fmgr_builtin_oid_index[9898] = {
