...
static void
_jumbleReturningExpr(JumbleState *jstate, Node *node)
{
...
static void
_jumbleReturningOption(JumbleState *jstate, Node *node)
{
...
static void
_jumbleReturningClause(JumbleState *jstate, Node *node)
{
...
static void
_jumbleATAlterConstraint(JumbleState *jstate, Node *node)
{
