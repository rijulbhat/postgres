...
static int weighted_pointers_rbtree_comparator(const RBTNode *a, const RBTNode *b, void *arg);
static void int_rbtree_combiner(RBTNode *existing, const RBTNode *newdata, void *arg);
static void weighted_pointers_rbtree_combiner(RBTNode *existing, const RBTNode *newdata, void *arg);
static RBTNode *int_rbtree_allocfunc(void *arg);
static RBTNode *weighted_pointers_rbtree_allocfunc(void *arg);
static void int_rbtree_freefunc(RBTNode *node, void *arg);
static void weighted_pointers_rbtree_freefunc(RBTNode *node, void *arg);
...
static bool is_binary_attr(CharPtrVector* vec, int index);
